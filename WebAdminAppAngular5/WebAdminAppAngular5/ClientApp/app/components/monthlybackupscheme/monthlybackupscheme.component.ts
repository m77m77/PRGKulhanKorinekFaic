...
@Component({
    selector: 'monthlybackupscheme',
    templateUrl: '../weeklybackupscheme/weeklybackupschemenew.component.html',
    styleUrls: ['../weeklybackupscheme/weeklybackupschemenew.component.css']

})
export class MonthlybackupschemeComponent {
