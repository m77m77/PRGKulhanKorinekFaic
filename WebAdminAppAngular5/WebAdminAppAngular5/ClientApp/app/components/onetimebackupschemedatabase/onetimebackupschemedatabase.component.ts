...
@Component({
    selector: 'onetimebackupschemedatabase',
    templateUrl: './onetimebackupschemedatabase.component.html',
    styleUrls: ['./onetimebackupschemedatabase.component.css']


})
export class OnetimebackupschemeDatabaseComponent {
    when: string;
